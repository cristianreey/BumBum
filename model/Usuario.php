...
";
    ...
    public static function subirImagen($pdo, $idUsuario, $imagen)
    {
        try {
            // Preparamos la consulta para insertar un nuevo registro en la tabla usuariossuperlike
            $query = "INSERT INTO usuariosimagenes (idUsuario, url , fechaPublicacion) VALUES (:idUsuario, :imagen, NOW())";
    ...
    public static function ModificarImagen($pdo, $idUsuario, $imagen)
    {
        try {
            // Preparamos la consulta para insertar un nuevo registro en la tabla usuariossuperlike
            $query = "UPDATE usuariosimagenes SET idUsuario = :idUsuario, url = :imagen, fechaPublicacion = NOW() WHERE idUsuario = :idUsuario";
