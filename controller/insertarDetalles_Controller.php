...
if (isset($_SESSION['idUsuario'])) {
    ...
    $datosUsuarioDetalles = Usuario::insertarUsuarioDetalles($pdo, $idUsuario, $provincia, $pais, $domicilio, $codigoPostal, $ciudad, $colorFavorito, $comidaFavorita, $deporteFavorito, $hobbie, $colorPiel, $altura, $colorPelo, $tatuajes, $colorOjos);
